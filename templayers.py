...
class MyLayerMaxPool(_Pooling2D):
    ...
    def _pooling_function(self, inputs, pool_size, strides,
        ...
        j1=range(0,y[2],2)
        j2=range(1,y[2],2)
        p1=[[[[k,i,j] for j in j1] for i in i1] for k in range(0,32)]
        p2=[[[[k,i,j] for j in j2] for i in i1] for k in range(0,32)]
        p3=[[[[k,i,j] for j in j1] for i in i2] for k in range(0,32)]
        p4=[[[[k,i,j] for j in j2] for i in i2] for k in range(0,32)]
